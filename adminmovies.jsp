...
<body>
<div class="topnav">
<a href="http://localhost:8060/cinema/adminmovies.jsp" target="_self"  class="active" >MOVIES</a>
<!--<a class="active" href="book.jsp" target="_self">Home</a>-->
<a href="http://localhost:8060/cinema/moviedetails.jsp" target="_self" class="active" >MOVIE DETAILS</a>
<a href="http://localhost:8060/cinema/payments.jsp" target="_self" class="active" >SHOW PAYMENTS</a>
